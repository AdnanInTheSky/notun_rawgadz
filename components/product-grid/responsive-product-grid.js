...
import '../product-card/responsive-product-card.js';

export class ResponsiveProductGrid extends LitElement {
  static properties = {
...
customElements.define('responsive-product-grid', ResponsiveProductGrid);
