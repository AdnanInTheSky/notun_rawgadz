// api/_pathao.js
// Pathao Courier Merchant API v1 Serverless Client Wrapper
 ...
 * Shares in-flight authentication promises to prevent token storms in serverless environments.
 */
...
/**
 * Helper: Fetch Pathao Order Details by consignment ID
 */
async function getPathaoOrderInfo(consignmentId) {
  return pathaoRequest(`/aladdin/api/v1/orders/${consignmentId}`);
}
